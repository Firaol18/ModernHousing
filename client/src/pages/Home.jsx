    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Michuu Housing is the best place to find your next perfect place to live.
          <br />
      ...
      <footer className="bg-slate-800 text-white py-6 mt-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} Michuu Housing. All rights reserved.</p>
